...
using namespace std;
        ...
        string presas[20] = {"Tavera", "SabanaYegua", "Sabaneta", "Moncion", "Rincon", "Jaguey", "Jimenoa"};
        float lenght=0;
        float cantmin[20]  = {20, 350, 200, 120, 32, 500, 25};
        float cantmax[20] = {100, 500, 600, 400, 80, 900, 350};
        float cantact[20] = {80, 500, 199, 121, 50, 845, 270};
        float n=7;
        char opcion;
        float porc[20];
        float pos;
...
int main()
{
    ...
    cout << endl;
    cout << "Digite 6:Para ver todos los valores introducidos." << endl;
    cout << endl;
    cout << "Digite 7: Agregar una presa "<< endl;
