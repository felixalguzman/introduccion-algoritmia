...
using namespace std;
        ...
        string presas[20] = {"Taveras", "Checo", "Sabaneta", "Monci\242n", "Rinc\242n", "Jaguey", "Jimenoa"};
        float lenght=0;
...
int n=7;
   ...
   // cout << "          encuentran actualmente a plena capacidad. " << endl;
    cout << endl;
    cout << "Digite 2: Para agregar una o m\240s presas."<< endl;
   ...
   // cout << "          m\240s bajo con respecto a su capacidad m\240xima." << endl;
    cout << endl;
    cout << "Digite 4: Para mostrar las presas que se encuentran" << endl;
    ...
    cout << endl;
    cout << "Digite 6: Para mostrar el porcentaje m\240s bajo del " << endl;
    cout << "          dep\242sito con respecto a su capacidad m\240xima," << endl;
    cout << "          estando encima de la cantidad m\241nima." << endl;
    cout << endl;
    cout << "Digite 7: Para mostrar cuantas presas se encuentran"<<endl;
    cout << "          por encima del nivel m\240ximo, cuantas por "<<endl;
    cout << "          debajo del m\241nimo y cuantas est\240n entre "<<endl;
    cout << "          ambos niveles."<< endl;
    cout << endl;
    cout << "Digite 8: Para mostrar un informe de orden descendente " << endl;
    ...
    case '7':
        ...
        parted(presas, cantmax, cantmin, n, cantact);
        // n=    insertar(presas, cantmax, cantmin, n, cantact, lenght);
        system("pause>nul");partee (presas, cantmax, cantmin, n, cantact);
        system("cls");
